...
npx hardhat --network <networkName> etherscan-verify --api-key <apikey>
...
```shell
npx hardhat verify --network bsc 0xac508f35150e3fbde4716c1a43ef3033d19c6d81 "Hello, Hardhat!"
```
